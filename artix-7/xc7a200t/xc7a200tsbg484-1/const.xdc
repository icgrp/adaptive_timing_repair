...
#set_property -dict { PACKAGE_PIN M17  IOSTANDARD LVCMOS12 } [get_ports { sw }]; #IO_25_15 Sch=sw[7]
...
# Pmod header JA
#set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports my_normal_clk]
#set_property -dict {PACKAGE_PIN AB21 IOSTANDARD LVCMOS33} [get_ports my_fast_clk]
#set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { my_data }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
#set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { my_psen }]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]
...
## Pmod header JB
#set_property -dict {PACKAGE_PIN V9 IOSTANDARD LVCMOS33} [get_ports my_normal_clk]
#set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports my_fast_clk]
#set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS33} [get_ports my_diff]
#set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVCMOS33} [get_ports my_psdone]
#set_property -dict {PACKAGE_PIN W9 IOSTANDARD LVCMOS33} [get_ports my_diff_2]
#set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { my_diff_3 }]; #IO_L24N_T3_34 Sch=jb_n[3]
#set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { my_diff_4 }]; #IO_L23P_T3_34 Sch=jb_p[4]
#set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { jb[7] }]; #IO_L23N_T3_34 Sch=jb_n[4]


## Pmod header JC
#set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { my_normal_clk }]; #IO_L18P_T2_34 Sch=jc_p[1]
#set_property -dict { PACKAGE_PIN AA6   IOSTANDARD LVCMOS33 } [get_ports { my_fast_clk}]; #IO_L18N_T2_34 Sch=jc_n[1]
#set_property -dict { PACKAGE_PIN AA8   IOSTANDARD LVCMOS33 } [get_ports { my_data }]; #IO_L22P_T3_34 Sch=jc_p[2]
#set_property -dict { PACKAGE_PIN AB8   IOSTANDARD LVCMOS33 } [get_ports { my_psen }]; #IO_L22N_T3_34 Sch=jc_n[2]
...
## XADC Header
#set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { my_normal_clk}]; #IO_L3P_T0_DQS_AD1P_15 Sch=xa_p[1]
#set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { my_fast_clk }]; #IO_L3N_T0_DQS_AD1N_15 Sch=xa_n[1]
#set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33 } [get_ports { my_data }]; #Imy_datO_L1P_T0_AD0P_15 Sch=xa_p[2]
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { my_psen }]; #IO_L1N_T0_AD0N_15 Sch=xa_n[2]
...
#set_pgroperty -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { tx }]; #IO_L14P_T2_SRCC_14 Sch=uart_tx_in
...
#Constraining the LUTs for the inverters
...
#Constraining the FFs for the Registers
...
#Constraining the LUT for the data_inferred LUT
